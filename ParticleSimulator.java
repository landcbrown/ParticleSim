...
public class ParticleSimulator extends JPanel {
    ...
    public ParticleSimulator() {
        ...
        while (i <= 5) {
            /*
            simulator.addParticle(new Particle(rand.nextDouble(Constants.SIMULATION_WIDTH), rand.nextDouble(Constants.SIMULATION_HEIGHT),
                    rand.nextDouble(-100,100), rand.nextDouble(-100,100),
                    rand.nextDouble(1, 10), rand.nextDouble(1, 5)));
             */
            double radius = 30;
            double mass = 5;
            ...
            double vx = rand.nextDouble(-100,100);
            double vy = rand.nextDouble(-100,100);
